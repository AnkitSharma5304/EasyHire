...
const UpdateProfileDialog = ({ open, setOpen }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:max-w-[500px] bg-white rounded-xl p-0 border border-ash-grey shadow-xl animate-fadeIn text-gray-800">
        ...
        <form onSubmit={submitHandler} className="space-y-6 px-6 pb-6 pt-4">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Input
              ...
              className="col-span-3 bg-white text-gray-900 border border-ash-grey focus:ring-tropical-teal focus:border-tropical-teal placeholder-gray-400"
              required
            />
          </div>
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Input
              ...
              className="col-span-3 text-gray-700 file:bg-tropical-teal file:text-white file:border-none file:px-4 file:py-1 file:rounded-md file:cursor-pointer"
            />
          </div>
          ...
          <DialogFooter>
            <Button
              type="submit"
              className="w-full bg-vibrant-coral hover:bg-vibrant-coral/90 disabled:bg-vibrant-coral/70
