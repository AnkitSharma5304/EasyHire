  ...
  return (
    <div className="min-h-screen flex flex-col bg-soft-linen text-gray-800">
      ...
      <div className="flex-grow px-6 py-12 animate-fadeIn">
        <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-lg p-10 border border-ash-grey">
          <h2 className="text-3xl font-bold mb-8 text-gray-800 border-b border-ash-grey pb-3">
            Edit Job
          </h2>
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-6">
            {[
              ...
              <div key={name}>
                ...
                <Input
                  ...
                  required
                  disabled={loading}
                  className="bg-white border border-ash-grey text-gray-800 placeholder-gray-400 focus:ring-tropical-teal focus:border-tropical-teal rounded-md"
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full mt-4 bg-gradient-to-r from-vibrant-coral to-tropical-teal hover:from-vibrant-coral/90 hover:to-tropical-teal/90 text-white font-semibold rounded-md transition-colors"
            >
