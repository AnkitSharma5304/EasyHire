...
const ShowJob = () => {
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-screen bg-soft-linen text-tropical-teal">
  ...
  if (!job) {
    return (
      <div className="flex justify-center items-center h-screen bg-soft-linen">
  ...
  return (
    <div className="min-h-screen flex flex-col bg-soft-linen">
      <Navbar />

      <div className="flex-grow px-6 py-10 animate-fadeIn">
        <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg border border-ash-grey p-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-6 tracking-tight">{job.title}</h1>
          ...
          <section className="space-y-5 text-gray-700 text-base leading-relaxed">
            ...
            <div>
              <p className="text-gray-800 font-semibold text-lg mb-1">Job Description</p>
              <p className="whitespace-pre-line text-gray-600">{job.description}</p>
            </div>

            <div>
              <p className="text-gray-800 font-semibold text-lg mb-1">Required Skills</p>
...
const InfoLabel = ({ label, value }) => (
  <div className="flex flex-col min-w-[120px]">
    <span className="text-tropical-teal font-semibold">{label}:</span>
